...
Create Table dbo.lk_visibilidad	(	 id_visibilidad int identity(1,1)
									,desc_codigo numeric(18,0)
...
Create Table dbo.lk_tipo_publi	(	 id_tipo_publi int identity(1,1)
									,desc_tipo_public nvarchar(255)
									,primary key (id_tipo_publi)
								)

Create Table dbo.lk_rubro	(	 id_rubro int identity(1,1)
								,desc_rubro nvarchar(255)
								,primary key (id_rubro)
							)

Create Table dbo.ft_publicacion	(	 id_publicacion int identity(1,1)
									,desc_codigo numeric(18,0)
...
Create Table dbo.ft_compra	(	 id_compra int identity(1,1)
								,desc_fecha datetime
...
Create Table dbo.ft_subasta	(	 id_subasta int identity(1,1)
								,desc_fecha datetime
...
Create Table dbo.lk_forma_pago	(	 id_forma_pago int identity(1,1)
									,desc_tipo_pago nvarchar(255)
									,primary key (id_forma_pago)
								)

Create Table dbo.ft_factura	(	 id_factura int identity(1,1)
...
Create Table dbo.ft_item	(	 id_item int identity(1,1)
